...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((modMask, xK_b), SM.submap . M.fromList $
            [ ((modMask, xK_f), spawn "firefox --new-window facebook.com")
            , ((modMask, xK_t), spawn "firefox --new-window twitter.com")
            , ((modMask, xK_g), spawn "firefox --new-window google.co.in")
            , ((modMask, xK_u), spawn "firefox --new-window youtube.com")
            , ((modMask, xK_m), spawn "firefox --new-window mail.google.com")
            , ((modMask, xK_o), spawn "google-chrome")
            , ((modMask, xK_space), spawn "firefox")
            , ((modMask, xK_BackSpace), spawn "firefox --private-window")
            ])
